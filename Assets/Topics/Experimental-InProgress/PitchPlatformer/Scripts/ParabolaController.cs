...
/// <summary>
/// Source: https://gist.github.com/ditzel/68be36987d8e7c83d48f497294c66e08#file-parabolacontroller-cs
/// </summary>
namespace Pocketboy.PitchPlatformer
{
    public class ParabolaController : MonoBehaviour
    {
        ...
        public delegate void ParabolaDelegate();
        public static ParabolaDelegate ReachedParabolaEnd;
        public static void OnReachedParabolaEnd()
        {
            if(ReachedParabolaEnd != null)
            {
                ReachedParabolaEnd();
            }
        }
        ...
        void OnDrawGizmos()
        {
            ...
            parabolaFly.RefreshTransforms(1f);
            if ((parabolaFly.Points.Length - 1) % 2 != 0)
                return;

            int accur = 50;
            Vector3 prevPos = parabolaFly.Points[0];
            for (int c = 1; c <= accur; c++)
            {
                float currTime = c * parabolaFly.GetDuration() / accur;
                Vector3 currPos = parabolaFly.GetPositionAtTime(currTime);
        ...
        void Update()
        {
            ...
            if (m_Animating && parabolaFly != null && animationTime < parabolaFly.GetDuration())
            {
            ...
            else if (m_Animating && parabolaFly != null && animationTime > parabolaFly.GetDuration())
            {
                animationTime = float.MaxValue;
                m_Animating = false;
                OnReachedParabolaEnd();
            }
        ...
        {
            parabolaFly = new ParabolaFly(points);
        }
        ...
        public class ParabolaFly
        {
            ...
            public ParabolaFly(Vector3[] parabolaPoints)
            {
