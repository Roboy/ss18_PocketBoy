...
namespace Pocketboy.Wordcloud
{
    ...
    public class SimpleHelvetica : MonoBehaviour
    {
        ...
        public Bounds GetCharacterSize(string s)
        {
            GameObject LetterToShow = transform.Find("_Alphabets/" + s).gameObject;
            ...
            for (int ctr = 0; ctr <= Text.Length - 1; ctr++)
            {
                ...
                if (Orientation == alignment.vertical)
                {
                    if (childObjectName != " ")
                    {
                        ...
                        Bounds bounds = mesh.bounds;
                        CharXLocation = 0;
                        CharYLocation -= bounds.size.y;

                    }
                    else
                    {
                        CharYLocation -= 2 * LineSpacing;
                    }
                }
        ...
        void AddLetter(GameObject LetterObject)
        {
            ...
            //NewLetter.transform.localScale *= 0.1f;
        ...
        void ResetText()
        {
            ...
            previousLetters = GetComponentsInChildren<Transform>(true);
        ...
        public void AddBoxCollider()
        {
            ...
            foreach (Transform child in transform)
            {
                if (child.name != "_Alphabets")
                {
                    ...
                    rr.Add(child.gameObject.GetComponent<Renderer>());
                }
            }
